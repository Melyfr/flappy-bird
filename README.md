...
Веб-версия игры Flappy Bird в минималистичном стиле, позволяющая игроку управлять "птицей" и пролететь через препятствия, чтобы получить максимальное количество очков. Управление осуществляется кликом на игровую область. Интерфейс игры адаптирован для различных размеров экрана.
#
